...
public final class CarControl {
    ...
    public static class NameValueTable {
        ...
        protected static boolean putString(ContentResolver resolver, Uri uri, String name, String value) {
            try {
                ...
                Log.w(CarControl.TAG, "Can't set key " + name + " in " + uri, e);
                return false;
            }
        }
    ...
    public static final class System extends NameValueTable {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://com.xiaopeng.carcontrol/system");
        private static final NameValueCache sNameValueCache = new NameValueCache(CONTENT_URI, CarControl.CALL_METHOD_GET_SYSTEM, CarControl.CALL_METHOD_PUT_SYSTEM);
    ...
    public static final class Quick extends NameValueTable {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://com.xiaopeng.carcontrol/quick");
        private static final NameValueCache sNameValueCache = new NameValueCache(CONTENT_URI, CarControl.CALL_METHOD_GET_QUICK, CarControl.CALL_METHOD_PUT_QUICK);
    ...
    public static final class PrivateControl extends NameValueTable {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://com.xiaopeng.carcontrol/private");
        private static final NameValueCache sNameValueCache = new NameValueCache(CONTENT_URI, CarControl.CALL_METHOD_GET_PRIVATE, CarControl.CALL_METHOD_PUT_PRIVATE);
    ...
    public static class NameValueCache {
        ...
        String getString(ContentResolver resolver, String name) {
            String str = this.mCallGetCommand;
            if (str != null) {
                try {
                    Bundle b = resolver.call(this.mUri, str, name, (Bundle) null);
                    if (b != null) {
                        return b.getString(VuiConstants.ELEMENT_VALUE);
                    }
                } catch (Exception e) {
                }
            }
            ...
            try {
                try {
                    Cursor c2 = resolver.query(Uri.withAppendedPath(this.mUri, name), null, null, null);
                    if (c2 != null) {
                        String string = c2.moveToNext() ? c2.getString(0) : null;
                        c2.close();
                        return string;
                    }
                    Log.w(CarControl.TAG, "Can't get key " + name + " from " + this.mUri);
                    if (c2 != null) {
                        c2.close();
                    }
                    return null;
                } catch (Exception e2) {
                    Log.w(CarControl.TAG, "Can't get key " + name + " from " + this.mUri, e2);
                    if (0 != 0) {
                        c.close();
                    }
                    return null;
        ...
        boolean putString(ContentResolver resolver, String name, String value) {
            try {
                ...
                arg.putString(VuiConstants.ELEMENT_VALUE, value);
                resolver.call(this.mUri, this.mCallSetCommand, name, arg);
                return true;
            } catch (Exception e) {
                Log.w(CarControl.TAG, "Can't set key " + name + " in " + this.mUri, e);
                return false;
            }
        }
    }
