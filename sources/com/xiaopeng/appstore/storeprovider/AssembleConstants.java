...
public class AssembleConstants {
    ...
    public static final String EXTRA_KEY_PARAMS_DIALOG_SHARE_ID = "extra_key_params_dialog_share_id";
    public static final String EXTRA_KEY_PARAMS_FILE_PATH = "extra_key_params_file_path";
    public static final String EXTRA_KEY_PARAMS_IGNORE_DOWNLOAD_LOCAL_CHECK = "extra_key_params_ignore_download_local_check";
    ...
    public static final String EXTRA_KEY_PARAMS_TOAST_SHARE_ID = "extra_key_params_toast_share_id";
    public static final String EXTRA_KEY_PARAMS_URL = "extra_key_params_url";
    public static final String EXTRA_KEY_RESERVED_PARAMS_URL = "extra_key_reserved_params_url";
    ...
    public static final int SHARE_ID_PRIMARY_SCREEN = 0;
    public static final int SHARE_ID_SECONDARY_SCREEN = 1;
