...
public abstract class AbsNaviListener implements NaviListener {
    ...
    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onNearbySearch(NearbySearchBean searchBean) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onControlVolOn(boolean pullUpNavi, int mode) {
    }

    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onControlVolOff(boolean pullUpNavi, int mode) {
    }

    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onRouteNearbySearch(NearbySearchBean searchBean) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onWaypointSearch(WaypointSearchBean bean) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onSetScaleLevel(int level) {
    }

    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onAlertsPreferenceSet(NaviPreferenceBean pref) {
    }

    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onAvoidRouteSet(NaviPreferenceBean pref) {
    }

    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onMapShowSet(NaviPreferenceBean pref) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onSetOritentionMetre(double metre, int oritention) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onControlChargeServiceOpen(String stateId) {
    }

    @Override // com.xiaopeng.speech.protocol.node.navi.NaviListener
    public void onControlGaodeAccountPageOpen(int pageId) {
    }
}
