...
public interface CaracListener extends INodeListener {
    ...
    default void onRearSeatHeatingOpenClose(int mode, int position) {
    }

    default void onRearSeatHeatSet(int position, ChangeValue changeValue) {
    }

    default void onRearSeatHeatUp(int position, ChangeValue changeValue) {
    }

    default void onRearSeatHeatDown(int position, ChangeValue changeValue) {
    }
