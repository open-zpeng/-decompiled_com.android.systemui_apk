...
public abstract class AbsCarcontrolListener implements CarcontrolListener {
    ...
    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLightLowOff(ControlReason reason) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLightAtmosphereOff(int mode) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onMirrorRearSet(int direction) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLegUp(int pilot) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLegDown(int pilot) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLegHighest(int pilot) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLegLowest(int pilot) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onChargePortControl(int position, int mode) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onWindowsControl(int position, int mode, int percent) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLightAtmosphereColor(CommandValue value) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onLightAtmosphereBrightnessSet(CommandValue value) {
    }
    ...
    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void setLluSw(boolean isOpen) {
    }

    @Override // com.xiaopeng.speech.protocol.node.carcontrol.CarcontrolListener
    public void onControlSunShade(int mode, int pos) {
    }
}
