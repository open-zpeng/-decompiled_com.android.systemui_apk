...
public class CarSpeechUIVuiQuery extends SpeechQuery<ISpeechVuiElementStateQueryCaller> {
    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_XSWITCH_CHECKED)
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_XTABLAYOUT_SELECTED)
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_XSLIDER_SETVALUE)
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_STATEFULBUTTON_CHECKED)
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_STATEFULBUTTON_SETVALUE)
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_ELEMENT_ENABLED)
    ...
    @com.xiaopeng.speech.annotation.QueryAnnotation(event = com.xiaopeng.speech.protocol.event.query.speech.CarSpeechUIVuiEvent.VUI_ELEMENT_SCROLL_STATE)
    /*
    ...
    */
    public boolean isElementCanScrolled(java.lang.String r17, java.lang.String r18) {
        ...
        La3:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaopeng.speech.protocol.query.speech.vui.CarSpeechUIVuiQuery.isElementCanScrolled(java.lang.String, java.lang.String):boolean");
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_ELEMENT_CHECKBOX_CHECKED)
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @QueryAnnotation(event = CarSpeechUIVuiEvent.VUI_ELEMENT_RADIOBUTTON_CHECKED)
