...
public class SpeechConstant {
    ...
    public static final boolean DEFAULT_SOUND_AREA_ENABLE = true;
    ...
    public static final String KEY_DIALOGUE_TIME = "key.dialogue.time";
    public static final String KEY_ENABLE_ANGLE_TIP = "SpeechConfig.angle_tip_enable";
    public static final String KEY_ENABLE_AUTO_CLOSE_NO_BODY_SOUND_AREA = "key.enable.close.nobody.sound.area";
    public static final String KEY_ENABLE_DOPPELGANGER = "key.enable.doppelganger";
    public static final String KEY_ENABLE_DRIVER_LOCATION = "key.enable.driver.location";
    public static final String KEY_ENABLE_EXTREME_SPEECH_DIALOG = "key.enable.extreme.speech_dialog";
    public static final String KEY_ENABLE_PASSENGER_LOCATION = "key.enable.passenger.location";
    public static final String KEY_ENABLE_REAR_LEFT = "key.enable.rear.left";
    public static final String KEY_ENABLE_REAR_RIGHT = "key.enable.rear.right";
    public static final String KEY_ENABLE_SPEECH_SCENE_TIP = "speech.scene.tip.enable";
    public static final String KEY_ENABLE_WAIT_AWAKE = "key.enable.wait.awake";
    ...
    public static final int TTS_CHAR_TIME = 250;
    ...
    public static String TTS_DEFAULT_SPEAKER = Speaker.ZHILINGFA;
    ...
    public static class SoundLocation {
        ...
        public static final int ALL_LOCATION_NEW = 999;
