...
public class VuiLifecycleObserver implements LifecycleObserver {
    ...
    public VuiLifecycleObserver(Context context, Lifecycle lifecycle, String sceneId, View rootView, IVuiSceneListener listener, IVuiElementChangedListener elementChangedListener, boolean needBuild, boolean keepCache) {
        this.mSceneId = sceneId;
        this.mListener = listener;
        this.mContext = context;
        this.mLifeCycle = lifecycle;
        this.mRootView = rootView;
        this.mElementChangedListener = elementChangedListener;
        this.mKeepCache = keepCache;
        this.mNeedBuild = needBuild;
    }
