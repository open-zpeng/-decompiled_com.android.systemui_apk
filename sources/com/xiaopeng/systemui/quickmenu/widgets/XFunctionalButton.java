...
public class XFunctionalButton extends FrameLayout {
    ...
    public XFunctionalButton(Context context) {
        this(context, null);
    }

    public XFunctionalButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XFunctionalButton(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public XFunctionalButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
