...
public class CircleImageView extends AppCompatImageView {
    ...
    private static final int SHOW_BORDER_WIDTH = 18;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = a.getDimensionPixelSize(2, 0);
        this.mBorderColor = a.getColor(0, -16777216);
        this.mBorderOverlay = a.getBoolean(1, false);
        this.mCircleBackgroundColor = a.getColor(3, 0);
        a.recycle();
        init();
    }

    public void showBorder(boolean show) {
        this.mBitmapWidth = show ? 18 : 0;
