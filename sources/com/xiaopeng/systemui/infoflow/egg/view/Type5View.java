...
public class Type5View extends BaseHolidayView {
    ...
    public View createView(final HolidayLayout layout) {
        ...
        View view = layoutInflater.inflate(R.layout.view_egg_type5, (ViewGroup) null);
        final ImageView iv = (ImageView) view.findViewById(R.id.iv_pic);
        iv.setImageDrawable(layout.getBackground());
        iv.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.systemui.infoflow.egg.view.Type5View.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                if (Type5View.this.mOnClickListener != null) {
                    iv.setTag(R.id.tag_url, layout.getUrl());
                    Type5View.this.mOnClickListener.onClick(iv);
                }
            }
        });
        ...
        if (layout.getBtns() != null && layout.getBtns().size() >= 2) {
            int[] ids = {R.id.btn_1, R.id.btn_2, R.id.btn_3};
            for (int i = 0; i < ids.length; i++) {
                TextView btn = (TextView) view.findViewById(ids[i]);
                btn.setBackground(layout.getBtnBackground(i));
                final int index = i;
                btn.setOnClickListener(new View.OnClickListener() { // from class: com.xiaopeng.systemui.infoflow.egg.view.Type5View.2
                    @Override // android.view.View.OnClickListener
                    public void onClick(View v) {
                        if (Type5View.this.mOnClickListener != null) {
                            v.setTag(R.id.tag_url, layout.getBtns().get(index).url);
                            Type5View.this.mOnClickListener.onClick(v);
                        }
                    }
                });
            }
