...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            Runnable mover = new Runnable() { // from class: com.xiaopeng.systemui.infoflow.message.anim.BaseItemAnimator.1
        ...
        if (changesPending) {
            ...
            Runnable changer = new Runnable() { // from class: com.xiaopeng.systemui.infoflow.message.anim.BaseItemAnimator.2
                @Override // java.lang.Runnable
                public void run() {
        ...
        if (additionsPending) {
            ...
            Runnable adder = new Runnable() { // from class: com.xiaopeng.systemui.infoflow.message.anim.BaseItemAnimator.3
                @Override // java.lang.Runnable
                public void run() {
                    Iterator it2 = additions.iterator();
                    while (it2.hasNext()) {
                        RecyclerView.ViewHolder holder3 = (RecyclerView.ViewHolder) it2.next();
                        BaseItemAnimator.this.animateAddImpl(holder3);
                    }
                    additions.clear();
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() { // from class: com.xiaopeng.systemui.infoflow.message.anim.BaseItemAnimator.4
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: com.xiaopeng.systemui.infoflow.message.anim.BaseItemAnimator.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() { // from class: com.xiaopeng.systemui.infoflow.message.anim.BaseItemAnimator.6
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator) {
