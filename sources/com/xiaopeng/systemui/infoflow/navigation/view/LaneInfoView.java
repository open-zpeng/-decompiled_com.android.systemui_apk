...
public class LaneInfoView extends AnimatedImageView {
    ...
    public static final int TYPE_NORMAL_LANE = 0;
    private static final int TYPE_NORMAL_TOLL_GATE = 0;
    public static final int TYPE_TOLL_GATE = 1;
    ...
    private void init() {
        ...
        this.mLaneLinePaint.setStrokeWidth(2.0f);
    ...
    private void drawTollGateLine(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < tollGateSize - 1; i2++) {
            ...
            canvas.drawRect(left, top, right, bottom, this.mLaneLinePaint);
        }
    }
