...
public class UIUtils {
    ...
    public static int getStatusBarHeight(Context context) {
        int resourceId1 = context.getResources().getIdentifier("status_bar_height", "dimen", SystemMediaRouteProvider.PACKAGE_NAME);
        int resourceId2 = context.getResources().getIdentifier("status_bar_bottom_height", "dimen", SystemMediaRouteProvider.PACKAGE_NAME);
        try {
    ...
    public static int getStatusBarBottomHeight(Context context) {
        int resourceId = context.getResources().getIdentifier("status_bar_bottom_height", "dimen", SystemMediaRouteProvider.PACKAGE_NAME);
        try {
