...
public class DefaultClockController implements ClockPlugin {
    ...
    public DefaultClockController(Resources res, LayoutInflater inflater, SysuiColorExtractor colorExtractor) {
        this.mResources = res;
    ...
    private void createViews() {
        this.mView = this.mLayoutInflater.inflate(R.layout.default_clock_preview, (ViewGroup) null);
    ...
    public void setTextColor(int color) {
        this.mTextTime.setTextColor(color);
        this.mTextDate.setTextColor(color);
    }
