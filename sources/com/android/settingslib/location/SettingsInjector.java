...
public class SettingsInjector {
    ...
    public static class MessengerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            boolean enabled = bundle.getBoolean(VuiConstants.ELEMENT_ENABLED, true);
    ...
    public final class Setting {
        ...
        public void startService() {
            ActivityManager am = (ActivityManager) SettingsInjector.this.mContext.getSystemService(SliceHints.HINT_ACTIVITY);
            ...
            intent.putExtra(PipMenuActivityController.EXTRA_CONTROLLER_MESSENGER, messenger);
            if (Log.isLoggable(SettingsInjector.TAG, 3)) {
