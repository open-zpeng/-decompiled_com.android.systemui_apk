                    ...
                    switch (msg.what) {
                        ...
                        case 5:
                            if ((msg.what == 4 && ApplicationsState.hasFlag(flags, 8)) || (msg.what == 5 && ApplicationsState.hasFlag(flags, 16))) {
                                ...
                                launchIntent.addCategory(msg.what == 4 ? "android.intent.category.LAUNCHER" : "android.intent.category.LEANBACK_LAUNCHER");
                                int i5 = 0;
                                                ...
                                                while (i7 < ApplicationsState.this.mAppEntries.size()) {
                                                    ...
                                                    if (ApplicationsState.hasFlag(entry5.info.flags, i2)) {
                                                        ...
                                                        if (entry5.size == -1 || entry5.sizeStale) {
                                                            if (entry5.sizeLoadStart == 0 || entry5.sizeLoadStart < now - WakeLock.DEFAULT_MAX_TIMEOUT) {
                                                                if (!this.mRunning) {
                                                                    this.mRunning = true;
