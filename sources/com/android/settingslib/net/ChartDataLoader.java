    ...
    private ChartData loadInBackground(NetworkTemplate template, AppItem app, int fields) throws RemoteException {
        ...
        if (app != null) {
            ...
            if (size > 0) {
                ...
                data.detailDefault = new NetworkStatsHistory((long) TimeUtils.TIME_ONE_HOUR);
                data.detailForeground = new NetworkStatsHistory((long) TimeUtils.TIME_ONE_HOUR);
                data.detail = new NetworkStatsHistory((long) TimeUtils.TIME_ONE_HOUR);
            }
        }
        return data;
    }
