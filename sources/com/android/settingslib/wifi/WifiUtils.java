...
public class WifiUtils {
    public static String buildLoggingSummary(AccessPoint accessPoint, WifiConfiguration config) {
        ...
        if (config != null && !config.getNetworkSelectionStatus().isNetworkEnabled()) {
            ...
            summary.append(NavigationBarInflaterView.KEY_CODE_END);
        }
        if (config != null) {
    ...
    static String getVisibilityStatus(AccessPoint accessPoint) {
        ...
        visibility.append(" [");
        if (num24 > 0) {
            visibility.append(NavigationBarInflaterView.KEY_CODE_START);
            visibility.append(num24);
            visibility.append(NavigationBarInflaterView.KEY_CODE_END);
            if (num24 > 4) {
        ...
        visibility.append(NavigationBarInflaterView.GRAVITY_SEPARATOR);
        if (num5 > 0) {
            visibility.append(NavigationBarInflaterView.KEY_CODE_START);
        ...
        visibility.append(NavigationBarInflaterView.SIZE_MOD_END);
