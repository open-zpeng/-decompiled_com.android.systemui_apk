...
public class InputMethodAndSubtypeEnablerManagerCompat implements Preference.OnPreferenceChangeListener {
    ...
    public void refresh(Context context, PreferenceFragmentCompat fragment) {
        ...
        InputMethodAndSubtypeUtilCompat.loadInputMethodSubtypeList(fragment, context.getContentResolver(), this.mInputMethodInfoList, this.mInputMethodAndSubtypePrefsMap);
        updateAutoSelectionPreferences();
    }

    public void save(Context context, PreferenceFragmentCompat fragment) {
        InputMethodAndSubtypeUtilCompat.saveInputMethodSubtypeList(fragment, context.getContentResolver(), this.mInputMethodInfoList, this.mHaveHardKeyboard);
    }
    ...
    private void addInputMethodSubtypePreferences(PreferenceFragmentCompat fragment, InputMethodInfo imi, PreferenceScreen root) {
        ...
        subtypePreferences.sort(new Comparator() { // from class: com.android.settingslib.inputmethod.-$$Lambda$InputMethodAndSubtypeEnablerManagerCompat$LAzLoY5JDn4eaG08pP_-eZZ7DnU
    ...
    public /* synthetic */ int lambda$addInputMethodSubtypePreferences$0$InputMethodAndSubtypeEnablerManagerCompat(Preference lhs, Preference rhs) {
