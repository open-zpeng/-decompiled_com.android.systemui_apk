...
public class InputMethodAndSubtypeUtil {
    ...
    public static HashMap<String, HashSet<String>> getEnabledInputMethodsAndSubtypeList(ContentResolver resolver) {
    ...
    public static void saveInputMethodSubtypeList(PreferenceFragment context, ContentResolver resolver, List<InputMethodInfo> inputMethodInfos, boolean hasHardKeyboard) {
        boolean isImeChecked;
        Iterator<InputMethodInfo> it;
        PreferenceFragment preferenceFragment = context;
        ...
        while (it2.hasNext()) {
            ...
            Preference pref = preferenceFragment.findPreference(imiId);
            if (pref != null) {
                ...
                if ((!hasHardKeyboard && InputMethodSettingValuesWrapper.getInstance(context.getActivity()).isAlwaysCheckedIme(imi)) || isImeChecked) {
                    ...
                    while (i < subtypeCount) {
                        ...
                        TwoStatePreference subtypePref = (TwoStatePreference) preferenceFragment2.findPreference(imiId + subtypeHashCodeStr);
                        if (subtypePref != null) {
                            if (!subtypePrefFound) {
                                subtypesSet.clear();
