...
class UsbDisconnectedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if ("android.hardware.usb.action.USB_ACCESSORY_DETACHED".equals(action) && (accessory = (UsbAccessory) intent.getParcelableExtra("accessory")) != null && accessory.equals(this.mAccessory)) {
            this.mActivity.finish();
        }
    }
}
