...
public class TaskStackChangeListeners extends TaskStackListener {
    ...
    public void onSingleTaskDisplayDrawn(int displayId) throws RemoteException {
        this.mHandler.obtainMessage(19, displayId, 0).sendToTarget();
    }

    public void onSingleTaskDisplayEmpty(int displayId) throws RemoteException {
        this.mHandler.obtainMessage(20, displayId, 0).sendToTarget();
    }

    public void onTaskDisplayChanged(int taskId, int newDisplayId) throws RemoteException {
        this.mHandler.obtainMessage(21, taskId, newDisplayId).sendToTarget();
    }
                ...
                switch (msg.what) {
                    ...
                    case 19:
                        for (int i19 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; i19 >= 0; i19--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(i19)).onSingleTaskDisplayDrawn(msg.arg1);
                        }
                        break;
                    case 20:
                        for (int i20 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; i20 >= 0; i20--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(i20)).onSingleTaskDisplayEmpty(msg.arg1);
                        }
                        break;
                    case 21:
                        for (int i21 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; i21 >= 0; i21--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(i21)).onTaskDisplayChanged(msg.arg1, msg.arg2);
                        }
                        break;
                }
            }
