...
public class AnglesClassifier extends StrokeClassifier {
    ...
    public float getFalseTouchEvaluation(int type, Stroke stroke) {
        ...
        return AnglesVarianceEvaluator.evaluate(data.getAnglesVariance(), type) + AnglesPercentageEvaluator.evaluate(data.getAnglesPercentage(), type);
    }
    ...
    private static class Data {
        ...
        public float getAnglesPercentage() {
            ...
            float result = (Math.max(this.mLeftAngles, this.mRightAngles) + this.mStraightAngles) / this.mAnglesCount;
            if (AnglesClassifier.VERBOSE) {
                String str = AnglesClassifier.TAG;
                FalsingLog.i(str, "getAnglesPercentage: left=" + this.mLeftAngles + " right=" + this.mRightAngles + " straight=" + this.mStraightAngles + " count=" + this.mAnglesCount + " result=" + result);
            }
            return result;
        }
    }
