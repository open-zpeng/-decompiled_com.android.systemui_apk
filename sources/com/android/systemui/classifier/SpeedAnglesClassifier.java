    ...
    private static class Data {
        ...
        public void addPoint(Point point) {
            ...
            if (!this.mLastThreePoints.isEmpty()) {
                ...
                if (list.get(list.size() - 1).equals(speedPoint)) {
                    return;
                }
            }
        ...
        public float getAnglesVariance() {
            ...
            float f3 = this.mSum;
            float v = (f / f2) - ((f3 / f2) * (f3 / f2));
            if (SpeedAnglesClassifier.VERBOSE) {
                FalsingLog.i(SpeedAnglesClassifier.TAG, "getAnglesVariance: sum^2=" + this.mSumSquares + " count=" + this.mCount + " result=" + v);
            }
            return v;
        }
        ...
        public float getAnglesPercentage() {
            ...
            float v = this.mAcceleratingAngles / f;
            if (SpeedAnglesClassifier.VERBOSE) {
                FalsingLog.i(SpeedAnglesClassifier.TAG, "getAnglesPercentage: angles=" + this.mAcceleratingAngles + " count=" + this.mAnglesCount + " result=" + v);
            }
            return v;
        }
    }
