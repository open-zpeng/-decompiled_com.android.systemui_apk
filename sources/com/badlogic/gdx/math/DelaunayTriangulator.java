...
public class DelaunayTriangulator {
    ...
    public ShortArray computeTriangles(float[] points, int offset, int count, boolean sorted) {
        ...
        if (count <= 32767) {
            ...
            while (pointIndex3 < end2) {
                ...
                while (triangleIndex2 >= 0) {
                    ...
                    if (completeArray2[completeIndex]) {
                        ...
                        if (s >= end2) {
                            int i5 = s - end2;
                            float x12 = superTriangle2[i5];
                            float y12 = superTriangle2[i5 + 1];
                            x1 = y12;
                            y1 = x12;
                        } else {
                            y1 = points2[s];
                        ...
                        if (s2 >= end2) {
                            int i6 = s2 - end2;
                            float x22 = superTriangle2[i6];
                            float y22 = superTriangle2[i6 + 1];
                            x2 = y22;
                            y2 = x22;
                        } else {
                            y2 = points2[s2];
                        ...
                        if (s3 >= end2) {
                            int i7 = s3 - end2;
                            float x32 = superTriangle2[i7];
                            float y32 = superTriangle2[i7 + 1];
                            x3 = y32;
                            y3 = x32;
                        } else {
                            y3 = points2[s3];
                        ...
                        } else if (circumCircle != z) {
                            complete = complete3;
                            triangles = triangles3;
                        } else {
                            completeArray[completeIndex] = z;
                            complete = complete3;
                            triangles = triangles3;
                        }
                    }
                ...
                int n = edges3.size;
                while (i8 < n) {
                    int p1 = edgesArray[i8];
                    if (p1 == -1) {
                        pointIndex = pointIndex4;
                    } else {
                        int p2 = edgesArray[i8 + 1];
                        boolean skip = false;
                        for (int ii = i8 + 2; ii < n; ii += 2) {
                        ...
                        if (skip) {
                            ...
                            triangles4.add(p1);
                            triangles4.add(edgesArray[i8 + 1]);
                            pointIndex = pointIndex4;
            ...
            int i9 = triangles5.size - i;
            while (i9 >= 0) {
                int end5 = end4;
                if (trianglesArray3[i9] >= end5 || trianglesArray3[i9 - 1] >= end5 || trianglesArray3[i9 - 2] >= end5) {
                    triangles5.removeIndex(i9);
                    triangles5.removeIndex(i9 - 1);
                    triangles5.removeIndex(i9 - 2);
                }
                i9 -= 3;
                end4 = end5;
            }
            if (!sorted) {
                ...
                for (int i10 = 0; i10 < n2; i10++) {
                    trianglesArray3[i10] = (short) (originalIndicesArray[trianglesArray3[i10] / 2] * 2);
                }
            }
            if (offset5 == 0) {
                int n3 = triangles5.size;
                for (int i11 = 0; i11 < n3; i11++) {
                    trianglesArray3[i11] = (short) (trianglesArray3[i11] / 2);
                }
            } else {
                int n4 = triangles5.size;
                for (int i12 = 0; i12 < n4; i12++) {
                    trianglesArray3[i12] = (short) ((trianglesArray3[i12] - offset5) / 2);
                }
            }
            return triangles5;
        }
