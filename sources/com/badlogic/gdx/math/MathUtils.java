...
public final class MathUtils {
    ...
    public static float atan2(float y, float x) {
        ...
        if (Math.abs(z) < 1.0f) {
            ...
            if (x < 0.0f) {
                return (y < 0.0f ? -3.1415927f : 3.1415927f) + atan;
            }
            return atan;
        }
    ...
    public static int floor(float value) {
        return ((int) (value + BIG_ENOUGH_FLOOR)) - 16384;
    }
    ...
    public static int ceil(float value) {
        return 16384 - ((int) (BIG_ENOUGH_FLOOR - value));
    }
    ...
    public static int round(float value) {
        return ((int) (value + BIG_ENOUGH_ROUND)) - 16384;
    }
