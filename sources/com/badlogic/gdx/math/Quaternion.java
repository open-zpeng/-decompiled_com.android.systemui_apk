...
public class Quaternion implements Serializable {
    ...
    public String toString() {
        return NavigationBarInflaterView.SIZE_MOD_START + this.x + "|" + this.y + "|" + this.z + "|" + this.w + NavigationBarInflaterView.SIZE_MOD_END;
    }
    ...
    public Quaternion setFromAxes(boolean normalizeAxes, float xx, float xy, float xz, float yx, float yy, float yz, float zx, float zy, float zz) {
        ...
        if (t >= 0.0f) {
            ...
            float s3 = (float) Math.sqrt(((xx2 + 1.0d) - yy2) - zz2);
            this.x = s3 * 0.5f;
            float s4 = 0.5f / s3;
            this.y = (yx2 + xy2) * s4;
            this.z = (xz2 + zx2) * s4;
            ...
            float s5 = (float) Math.sqrt(((yy2 + 1.0d) - xx2) - zz2);
            this.y = s5 * 0.5f;
            float s6 = 0.5f / s5;
            this.x = (yx2 + xy2) * s6;
            this.z = (zy2 + yz2) * s6;
            ...
            float s7 = (float) Math.sqrt(((zz2 + 1.0d) - xx2) - yy2);
            this.z = s7 * 0.5f;
            float s8 = 0.5f / s7;
            this.x = (xz2 + zx2) * s8;
            this.y = (zy2 + yz2) * s8;
    ...
    public float getAngleAroundRad(float axisX, float axisY, float axisZ) {
        ...
        return (float) (Math.acos(MathUtils.clamp((float) ((d < 0.0f ? -this.w : this.w) / Math.sqrt(l2)), -1.0f, 1.0f)) * 2.0d);
    }
