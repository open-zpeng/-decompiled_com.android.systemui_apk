...
public class FileHandle {
    ...
    public InputStream read() {
        if (this.type == Files.FileType.Classpath || ((this.type == Files.FileType.Internal && !file().exists()) || (this.type == Files.FileType.Local && !file().exists()))) {
            ...
            if (input == null) {
                throw new GdxRuntimeException("File not found: " + this.file + " (" + this.type + NavigationBarInflaterView.KEY_CODE_END);
            }
            return input;
        }
        try {
            ...
            if (file().isDirectory()) {
                throw new GdxRuntimeException("Cannot open a stream to a directory: " + this.file + " (" + this.type + NavigationBarInflaterView.KEY_CODE_END, ex);
            }
            throw new GdxRuntimeException("Error reading file: " + this.file + " (" + this.type + NavigationBarInflaterView.KEY_CODE_END, ex);
        }
    }
    ...
    public ByteBuffer map(FileChannel.MapMode mode) {
        ...
        try {
            try {
                ...
                throw new GdxRuntimeException("Error memory mapping file: " + this + " (" + this.type + NavigationBarInflaterView.KEY_CODE_END, ex);
            }
        } finally {
    ...
    public OutputStream write(boolean append) {
        if (this.type == Files.FileType.Classpath) {
            ...
            try {
                ...
                throw new GdxRuntimeException("Error writing file: " + this.file + " (" + this.type + NavigationBarInflaterView.KEY_CODE_END, ex);
            }
        }
    }
    ...
    public void write(InputStream input, boolean append) {
        ...
        try {
            try {
                ...
                throw new GdxRuntimeException("Error stream writing to file: " + this.file + " (" + this.type + NavigationBarInflaterView.KEY_CODE_END, ex);
            }
        } finally {
            StreamUtils.closeQuietly(input);
