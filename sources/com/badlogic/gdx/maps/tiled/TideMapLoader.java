...
public class TideMapLoader extends SynchronousAssetLoader<TiledMap, Parameters> {
    ...
    private TiledMap loadMap(XmlReader.Element root, FileHandle tmxFile, ImageResolver imageResolver) {
        ...
        Iterator<XmlReader.Element> it = tilesheets.getChildrenByName("TileSheet").iterator();
        while (it.hasNext()) {
        ...
        Iterator<XmlReader.Element> it2 = layers.getChildrenByName("Layer").iterator();
        while (it2.hasNext()) {
        ...
        if (element.getName().equals("Properties")) {
            ...
            while (it.hasNext()) {
                ...
                if (type.equals("Int32")) {
                    ...
                    properties.put(key, Boolean.valueOf(value.equalsIgnoreCase(OOBEEvent.STRING_TRUE)));
                } else {
                    properties.put(key, value);
                }
            }
