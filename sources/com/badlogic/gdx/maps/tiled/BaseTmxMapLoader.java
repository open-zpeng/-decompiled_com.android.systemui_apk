...
public abstract class BaseTmxMapLoader<P extends Parameters> extends AsynchronousAssetLoader<TiledMap, P> {
    ...
    public TiledMap loadTiledMap(FileHandle tmxFile, P parameter, ImageResolver imageResolver) {
        ...
        for (Iterator<XmlReader.Element> it = tilesets.iterator(); it.hasNext(); it = it) {
        ...
        if (element.getName().equals("layer")) {
            ...
            while (y < height) {
                ...
                while (x < width2) {
                    ...
                    boolean flipHorizontally = (Integer.MIN_VALUE & id) != 0 ? true : z;
                    boolean flipVertically = (FLAG_FLIP_VERTICALLY & id) != 0 ? true : z;
                    boolean flipDiagonally = (id & FLAG_FLIP_DIAGONALLY) == 0 ? z : true;
    ...
    protected void loadImageLayer(TiledMap map, MapLayers parentLayers, XmlReader.Element element, FileHandle tmxFile, ImageResolver imageResolver) {
        ...
        if (element.getName().equals("imagelayer")) {
            ...
            XmlReader.Element image = element.getChildByName(CardExtra.KEY_CARD_IMAGE);
            if (image != null) {
    ...
    protected void loadProperties(MapProperties properties, XmlReader.Element element) {
        if (element != null && element.getName().equals("properties")) {
            ...
            while (it.hasNext()) {
                ...
                String value = property.getAttribute(VuiConstants.ELEMENT_VALUE, null);
                String type = property.getAttribute(VuiConstants.ELEMENT_TYPE, null);
                if (value == null) {
    ...
    protected void loadTileSet(XmlReader.Element element, FileHandle tmxFile, ImageResolver imageResolver) {
        ...
        if (element.getName().equals("tileset")) {
            ...
            if (source != null) {
                ...
                try {
                    element2 = this.xml.parse(tsx);
                } catch (SerializationException e) {
                }
                try {
                    XmlReader.Element imageElement2 = element2.getChildByName(CardExtra.KEY_CARD_IMAGE);
                ...
                XmlReader.Element imageElement3 = element.getChildByName(CardExtra.KEY_CARD_IMAGE);
            ...
            while (it.hasNext()) {
                ...
                int localtid = tileElement.getIntAttribute("id", i3);
            ...
            Iterator<AnimatedTiledMapTile> it2 = animatedTiles.iterator();
            while (it2.hasNext()) {
                AnimatedTiledMapTile animatedTile2 = it2.next();
