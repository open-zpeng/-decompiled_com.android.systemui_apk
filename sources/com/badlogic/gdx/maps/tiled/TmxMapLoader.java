...
public class TmxMapLoader extends BaseTmxMapLoader<Parameters> {
    ...
    private Array<FileHandle> getDependencyFileHandles(FileHandle tmxFile) {
        ...
        while (it.hasNext()) {
            ...
            if (source != null) {
                ...
                XmlReader.Element imageElement = tileset2.getChildByName(CardExtra.KEY_CARD_IMAGE);
                if (imageElement != null) {
                    String imageSource = tileset2.getChildByName(CardExtra.KEY_CARD_IMAGE).getAttribute("source");
                    ...
                    while (it2.hasNext()) {
                        ...
                        String imageSource2 = tile.getChildByName(CardExtra.KEY_CARD_IMAGE).getAttribute("source");
                        FileHandle image2 = getRelativeFileHandle(tsxFile, imageSource2);
                        fileHandles.add(image2);
                    }
                }
            } else {
                XmlReader.Element imageElement2 = tileset.getChildByName(CardExtra.KEY_CARD_IMAGE);
                if (imageElement2 != null) {
                    String imageSource3 = tileset.getChildByName(CardExtra.KEY_CARD_IMAGE).getAttribute("source");
                    ...
                    while (it3.hasNext()) {
                        ...
                        String imageSource4 = tile2.getChildByName(CardExtra.KEY_CARD_IMAGE).getAttribute("source");
        ...
        while (it4.hasNext()) {
            ...
            XmlReader.Element image5 = imageLayer.getChildByName(CardExtra.KEY_CARD_IMAGE);
    ...
    protected void addStaticTiles(FileHandle tmxFile, ImageResolver imageResolver, TiledMapTileSet tileSet, XmlReader.Element element, Array<XmlReader.Element> tileElements, String name, int firstgid, int tilewidth, int tileheight, int spacing, int margin, String source, int offsetX, int offsetY, String imageSource, int imageWidth, int imageHeight, FileHandle image) {
        ...
        while (it.hasNext()) {
            ...
            XmlReader.Element imageElement = tileElement.getChildByName(CardExtra.KEY_CARD_IMAGE);
            if (imageElement != null) {
