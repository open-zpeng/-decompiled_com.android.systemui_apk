...
public class JsonValue implements Iterable<JsonValue> {
    ...
    public String asString() {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                return this.longValue != 0 ? OOBEEvent.STRING_TRUE : OOBEEvent.STRING_FALSE;
            } else if (i == 5) {
                return null;
            } else {
    ...
    public boolean asBoolean() {
        ...
        return this.stringValue.equalsIgnoreCase(OOBEEvent.STRING_TRUE);
    }
    ...
    public String[] asStringArray() {
        ...
        while (value != null) {
            ...
            if (i2 == 1) {
                ...
                v = value.longValue != 0 ? OOBEEvent.STRING_TRUE : OOBEEvent.STRING_FALSE;
            } else if (i2 == 5) {
                v = null;
            } else {
    ...
    private void json(JsonValue object, StringBuilder buffer, JsonWriter.OutputType outputType) {
        if (object.isObject()) {
            ...
            for (JsonValue child = object.child; child != null; child = child.next) {
                ...
                buffer.append(AccessibilityUtils.ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR);
        ...
        if (jsonValue.type == ValueType.array) {
            ...
            while (true) {
                if (child == null) {
                    ...
                    trace = NavigationBarInflaterView.SIZE_MOD_START + i + NavigationBarInflaterView.SIZE_MOD_END;
                    break;
                }
            }
        } else {
