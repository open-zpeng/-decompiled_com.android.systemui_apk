...
public class StringBuilder implements Appendable, CharSequence {
    ...
    final void reverse0() {
        ...
        while (i2 < mid) {
            ...
            boolean surAtFront = (!allowFrontSur || frontLow < 56320 || frontLow > 57343 || frontHigh < 55296 || frontHigh > 56319) ? z : true;
    ...
    public String toString() {
        int i = this.length;
        return i == 0 ? "" : new String(this.chars, 0, i);
    }
    ...
    public StringBuilder append(boolean b) {
        append0(b ? OOBEEvent.STRING_TRUE : OOBEEvent.STRING_FALSE);
        return this;
    }
    ...
    public StringBuilder append(int value, int minLength, char prefix) {
        ...
        if (value >= 10000) {
            ...
            if (value >= 100000000) {
                append0(digits[(value % Utils.SECOND_IN_NANOS) / 100000000]);
            }
            if (value >= 10000000) {
    ...
    public StringBuilder append(long value, int minLength, char prefix) {
        ...
        if (value >= 10000) {
            if (value >= 1000000000000000000L) {
                append0(digits[(int) ((value % 1.0E19d) / 1.0E18d)]);
            }
    ...
    public StringBuilder insert(int offset, boolean b) {
        insert0(offset, b ? OOBEEvent.STRING_TRUE : OOBEEvent.STRING_FALSE);
        return this;
    }
