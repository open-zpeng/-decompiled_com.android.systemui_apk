...
public class JsonWriter extends Writer {
    ...
    public class JsonObject {
        ...
        void close() throws IOException {
            JsonWriter.this.writer.write(this.array ? 93 : SpeechConstant.SoundLocation.DEF_PASSENGER_ANGLE);
        }
    }
    ...
    public enum OutputType {
        ...
        public String quoteValue(Object value) {
            ...
            if (this == minimal && !string.equals(OOBEEvent.STRING_TRUE) && !string.equals(OOBEEvent.STRING_FALSE) && !string.equals("null") && !string.contains("//") && !string.contains("/*") && (length = buffer.length()) > 0 && buffer.charAt(length - 1) != ' ' && minimalValuePattern.matcher(buffer).matches()) {
