...
public class Json {
    ...
    public void setElementType(Class type, String fieldName, Class elementType) {
        ...
        if (metadata == null) {
            throw new SerializationException("Field not found: " + fieldName + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END);
        }
    ...
    public void toJson(Object object, Class knownType, Class elementType, FileHandle file) {
        ...
        try {
            try {
                writer = file.writer(false, Key.STRING_CHARSET_NAME);
    ...
    */
                ...
                for (int i = 0; i < n; i++) {
                    ...
                    if (!this.ignoreDeprecated || !metadata.deprecated) {
                        ...
                        try {
                            ...
                            ex.addTrace(field + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END);
                            throw ex;
                        } catch (ReflectionException ex2) {
                            throw new SerializationException("Error accessing field: " + field.getName() + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END, ex2);
                        } catch (RuntimeException runtimeEx) {
                            SerializationException ex3 = new SerializationException(runtimeEx);
                            ex3.addTrace(field + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END);
                            throw ex3;
                        }
                    }
                }
    ...
    public void writeValue(Object value, Class knownType, Class elementType) {
        try {
            ...
            if ((knownType == null || !knownType.isPrimitive()) && knownType != String.class && knownType != Integer.class && knownType != Boolean.class && knownType != Float.class && knownType != Long.class && knownType != Double.class && knownType != Short.class && knownType != Byte.class && knownType != Character.class) {
                ...
                if (!actualType.isPrimitive() && actualType != String.class && actualType != Integer.class && actualType != Boolean.class && actualType != Float.class && actualType != Long.class && actualType != Double.class && actualType != Short.class && actualType != Byte.class && actualType != Character.class) {
                    ...
                    if (serializer != null) {
                        ...
                        if (this.typeName != null && (knownType == null || knownType != actualType)) {
                            ...
                            this.writer.name(VuiConstants.ELEMENT_VALUE);
                ...
                writeObjectStart(actualType, null);
                writeValue(VuiConstants.ELEMENT_VALUE, value);
                writeObjectEnd();
                return;
            }
    ...
    public void readField(Object object, Field field, String jsonName, Class elementType, JsonValue jsonMap) {
        ...
        try {
            ...
            ex.addTrace(field.getName() + " (" + field.getDeclaringClass().getName() + NavigationBarInflaterView.KEY_CODE_END);
            throw ex;
        } catch (ReflectionException ex2) {
            throw new SerializationException("Error accessing field: " + field.getName() + " (" + field.getDeclaringClass().getName() + NavigationBarInflaterView.KEY_CODE_END, ex2);
        } catch (RuntimeException runtimeEx) {
            SerializationException ex3 = new SerializationException(runtimeEx);
            ex3.addTrace(jsonValue.trace());
            ex3.addTrace(field.getName() + " (" + field.getDeclaringClass().getName() + NavigationBarInflaterView.KEY_CODE_END);
            throw ex3;
        }
    }
        ...
        for (JsonValue child = jsonMap.child; child != null; child = child.next) {
            ...
            if (metadata == null) {
                if (!child.name.equals(this.typeName) && !this.ignoreUnknownFields && !ignoreUnknownField(type, child.name)) {
                    SerializationException ex = new SerializationException("Field not found: " + child.name + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END);
                ...
                try {
                    ...
                    ex2.addTrace(field.getName() + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END);
                    throw ex2;
                } catch (ReflectionException ex3) {
                    throw new SerializationException("Error accessing field: " + field.getName() + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END, ex3);
                } catch (RuntimeException runtimeEx) {
                    SerializationException ex4 = new SerializationException(runtimeEx);
                    ex4.addTrace(child.trace());
                    ex4.addTrace(field.getName() + " (" + type.getName() + NavigationBarInflaterView.KEY_CODE_END);
                    throw ex4;
                }
            }
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:114:0x0181, code lost:
        if (r10 == java.lang.Object.class) goto L166;
     */
    ...
    /* JADX WARN: Type inference failed for: r4v16, types: [T, com.badlogic.gdx.utils.ArrayMap] */
    /* JADX WARN: Type inference failed for: r4v21, types: [T, com.badlogic.gdx.utils.ObjectSet] */
    /* JADX WARN: Type inference failed for: r4v23, types: [T, com.badlogic.gdx.utils.ObjectMap] */
