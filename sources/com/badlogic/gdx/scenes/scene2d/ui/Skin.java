...
public class Skin implements Disposable {
    ...
    public Drawable newDrawable(Drawable drawable, Color tint) {
        ...
        if (newDrawable instanceof BaseDrawable) {
            ...
            if (drawable instanceof BaseDrawable) {
                named.setName(((BaseDrawable) drawable).getName() + " (" + tint + NavigationBarInflaterView.KEY_CODE_END);
            } else {
                named.setName(" (" + tint + NavigationBarInflaterView.KEY_CODE_END);
            }
        }
        return newDrawable;
    }
    ...
    public void setEnabled(Actor actor, boolean enabled) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append(name.replace("-disabled", ""));
        ...
        json.setSerializer(TintedDrawable.class, new Json.ReadOnlySerializer() { // from class: com.badlogic.gdx.scenes.scene2d.ui.Skin.5
            ...
            public Object read(Json json2, JsonValue jsonData, Class type) {
                ...
                if (drawable instanceof BaseDrawable) {
                    ...
                    named.setName(jsonData.name + " (" + name + ", " + color + NavigationBarInflaterView.KEY_CODE_END);
                }
                return drawable;
            }
        });
