...
public class TextField extends Widget implements Disableable {
    ...
    private Drawable getBackgroundDrawable() {
        ...
        return (!this.disabled || this.style.disabledBackground == null) ? (!focused || this.style.focusedBackground == null) ? this.style.background : this.style.focusedBackground : this.style.disabledBackground;
    }
    ...
    int delete(boolean fireChangeEvent) {
        ...
        String str = "";
        sb.append(minIndex > 0 ? this.text.substring(0, minIndex) : "");
                ...
                if ((character == '\t' || character == '\n') && TextField.this.focusTraversal) {
                    ...
                    if (add || remove) {
                        ...
                        if (add && !remove) {
                            ...
                            TextField textField6 = TextField.this;
                            if (!textField6.withinMaxLength(textField6.text.length())) {
                                return true;
                            }
                            if (TextField.this.hasSelection) {
                                TextField textField7 = TextField.this;
