...
public class Color {
    ...
    public static Color valueOf(String hex) {
        ...
        int r = Integer.valueOf(hex2.substring(0, 2), 16).intValue();
        int g = Integer.valueOf(hex2.substring(2, 4), 16).intValue();
        int b = Integer.valueOf(hex2.substring(4, 6), 16).intValue();
        int a = hex2.length() != 8 ? 255 : Integer.valueOf(hex2.substring(6, 8), 16).intValue();
    ...
    public static void rgba4444ToColor(Color color, int value) {
        ...
        color.b = ((value & StackStateAnimator.ANIMATION_DURATION_BLOCKING_HELPER_FADE) >>> 4) / 15.0f;
