...
public class G3dModelLoader extends ModelLoader<ModelLoader.ModelParameters> {
    ...
    public ModelData parseModel(FileHandle handle) {
        ...
        JsonValue version = json.require(BaseIconCache.IconDB.COLUMN_VERSION);
        ...
        if (meshes != null) {
            ...
            while (mesh != null) {
                ...
                while (meshPart != null) {
                    ...
                    jsonPart.id = partId;
                    String type = meshPart.getString(VuiConstants.ELEMENT_TYPE, null);
                    if (type == null) {
            ...
            while (material != null) {
                ...
                if (textures != null) {
                    ...
                    while (texture != null) {
                        ...
                        String id2 = id;
                        String id3 = "/";
                        sb.append((materialDir.length() == 0 || materialDir.endsWith("/")) ? "" : "");
                        sb.append(fileName);
                        ...
                        String textureType = texture.getString(VuiConstants.ELEMENT_TYPE, null);
                        if (textureType != null) {
                    ...
                    if (keyframes2 == null || !keyframes2.isArray()) {
                        ...
                        if (translationKF != null && translationKF.isArray()) {
                            ...
                            for (JsonValue keyframe = translationKF.child; keyframe != null; keyframe = keyframe.next) {
                                ...
                                JsonValue translation = keyframe.get(VuiConstants.ELEMENT_VALUE);
                                if (translation != null && translation.size >= 3) {
                        ...
                        if (rotationKF != null && rotationKF.isArray()) {
                            ...
                            for (JsonValue keyframe2 = rotationKF.child; keyframe2 != null; keyframe2 = keyframe2.next) {
                                ...
                                JsonValue rotation = keyframe2.get(VuiConstants.ELEMENT_VALUE);
                        ...
                        if (scalingKF != null && scalingKF.isArray()) {
                            ...
                            for (JsonValue keyframe3 = scalingKF.child; keyframe3 != null; keyframe3 = keyframe3.next) {
                                ...
                                JsonValue scaling = keyframe3.get(VuiConstants.ELEMENT_VALUE);
