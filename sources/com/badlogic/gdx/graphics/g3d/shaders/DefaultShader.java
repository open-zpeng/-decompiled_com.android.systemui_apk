...
public class DefaultShader extends BaseShader {
    ...
    public DefaultShader(Renderable renderable, Config config, ShaderProgram shaderProgram) {
        ...
        this.shadowMap = (!this.lighting || renderable.environment.shadowMap == null) ? false : z;
        ...
        if (!config.ignoreUnimplemented) {
            ...
            if ((j & j2) != j2) {
                throw new GdxRuntimeException("Some attributes not implemented yet (" + this.attributesMask + NavigationBarInflaterView.KEY_CODE_END);
            }
        }
    ...
    public static String createPrefix(Renderable renderable, Config config) {
        ...
        String prefix = and(vertexMask, 1L) ? "#define positionFlag\n" : "";
        if (or(vertexMask, 6L)) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:113:0x00f6 A[EDGE_INSN: B:113:0x00f6->B:43:0x00f6 ?: BREAK  , SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:114:0x00ed A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:117:0x01c6 A[EDGE_INSN: B:117:0x01c6->B:74:0x01c6 ?: BREAK  , SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:121:0x01bb A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:123:0x02a2 A[EDGE_INSN: B:123:0x02a2->B:103:0x02a2 ?: BREAK  , SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:124:0x029e A[SYNTHETIC] */
