...
public abstract class ColorInfluencer extends Influencer {
    ...
    public static class Single extends ColorInfluencer {
        ...
        public void write(Json json) {
            json.writeValue(ThemeManager.AttributeSet.ALPHA, this.alphaValue);
            json.writeValue("color", this.colorValue);
        }

        @Override // com.badlogic.gdx.graphics.g3d.particles.ParticleControllerComponent, com.badlogic.gdx.utils.Json.Serializable
        public void read(Json json, JsonValue jsonData) {
            this.alphaValue = (ScaledNumericValue) json.readValue(ThemeManager.AttributeSet.ALPHA, ScaledNumericValue.class, jsonData);
