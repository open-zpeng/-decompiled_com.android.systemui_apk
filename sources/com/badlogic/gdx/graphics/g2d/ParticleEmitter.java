...
public class ParticleEmitter {
    ...
    */
    ...
    static String readString(String line) throws IOException {
        return line.substring(line.indexOf(NavigationBarInflaterView.KEY_IMAGE_DELIM) + 1).trim();
    }
    ...
    public static class NumericValue extends ParticleValue {
        ...
        public void load(BufferedReader reader) throws IOException {
            super.load(reader);
            if (this.active) {
                this.value = ParticleEmitter.readFloat(reader, VuiConstants.ELEMENT_VALUE);
            }
        }
