...
public class GLSurfaceView20API18 extends GLSurfaceViewAPI18 {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        BaseInputConnection connection = new BaseInputConnection(this, false) { // from class: com.badlogic.gdx.backends.android.surfaceview.GLSurfaceView20API18.1
    ...
    public static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            ...
            Log.w(GLSurfaceView20API18.TAG, String.format("%d configurations", Integer.valueOf(numConfigs)));
