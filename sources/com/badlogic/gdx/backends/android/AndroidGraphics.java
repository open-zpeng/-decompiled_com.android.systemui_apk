...
public class AndroidGraphics implements Graphics, GLSurfaceView.Renderer {
    ...
    private void logConfig(EGLConfig config) {
        ...
        Application application = Gdx.app;
        application.log(LOG_TAG, "framebuffer: (" + r + ", " + g + ", " + b + ", " + a + NavigationBarInflaterView.KEY_CODE_END);
        Application application2 = Gdx.app;
        ...
        Application application3 = Gdx.app;
        application3.log(LOG_TAG, "stencilbuffer: (" + s + NavigationBarInflaterView.KEY_CODE_END);
        Application application4 = Gdx.app;
        application4.log(LOG_TAG, "samples: (" + samples + NavigationBarInflaterView.KEY_CODE_END);
        Application application5 = Gdx.app;
        application5.log(LOG_TAG, "coverage sampling: (" + coverageSample + NavigationBarInflaterView.KEY_CODE_END);
    ...
    public void setUndecorated(boolean undecorated) {
        this.app.getApplicationWindow().setFlags(1024, undecorated ? 1 : 0);
    }
    ...
    public void setContinuousRendering(boolean isContinuous) {
        if (this.view != null) {
            ...
            View view2 = this.view;
            if (view2 instanceof GLSurfaceView) {
                int renderMode2 = z ? 1 : 0;
                ((GLSurfaceView) view2).setRenderMode(renderMode2);
            }
            this.mean.clear();
        }
    }
